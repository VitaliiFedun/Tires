...
abstract class autoProductActions extends sfActions
{
  ...
  public function executeNew(sfWebRequest $request)
  {
    ...
    $this->tiresproduct = $this->form->getObject();
  }
  ...
  {
    $this->tiresproduct = $this->getRoute()->getObject();
    $this->form = $this->configuration->getForm($this->tiresproduct);
  }
  ...
  public function executeBatch(sfWebRequest $request)
  {
    ...
    $validator = new sfValidatorDoctrineChoice(array('multiple' => true, 'model' => 'TiresProduct'));
    try
    {
      // validate ids
