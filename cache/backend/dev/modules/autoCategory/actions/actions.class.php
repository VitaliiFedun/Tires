...
abstract class autoCategoryActions extends sfActions
{
  ...
  public function executeNew(sfWebRequest $request)
  {
    ...
    $this->tirescategory = $this->form->getObject();
  }
  ...
  {
    $this->tirescategory = $this->getRoute()->getObject();
    $this->form = $this->configuration->getForm($this->tirescategory);
  }
  ...
  public function executeBatch(sfWebRequest $request)
  {
    ...
    $validator = new sfValidatorDoctrineChoice(array('multiple' => true, 'model' => 'TiresCategory'));
    try
    {
      // validate ids
  ...
  protected function processForm(sfWebRequest $request, sfForm $form)
  {
    ...
    if ($form->isValid())
    {
      ...
      $this->dispatcher->notify(new sfEvent($this, 'admin.save_object', array('object' => $tirescategory)));

      if ($request->hasParameter('_save_and_add'))
      {
        $this->getUser()->setFlash('notice', $notice.' You can add another one below.');

        $this->redirect('@tires_category_new');
      }
      else
      {
        $this->getUser()->setFlash('notice', $notice);

        $this->redirect(array('sf_route' => 'tires_category_edit', 'sf_subject' => $tirescategory));
      }
    }
    else
    {
  ...
  {
    $pager = $this->configuration->getPager('TiresCategory');
  ...
  {
    return Doctrine_Core::getTable('TiresCategory')->hasColumn($column);
  }
}
